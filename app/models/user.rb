...
class User < ApplicationRecord
  ...
  validates :phone, length: { minimum: 8, maximum: 10, message: 'Invalid phone number' },
                    presence: { message: "Phone number can't be empty" }, uniqueness: { message: 'Already exist', case_sensitive: false }, numericality: { message: 'It should be numbers' }
